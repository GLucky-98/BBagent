...
import { useAppStore, useSelectedAgent } from "../store";
      ...
      <div
        className={cn(
          ...
          isUser
            ...
            : "bg-[--color-secondary] rounded-tl-sm"
        )}
      >
        ...
        <span
          className={cn(
            ...
            isUser
              ? "text-[--color-primary-foreground]/60"
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[--color-muted-foreground]">
              {selectedAgent.type === "team" ? "Agent Team" : "Single Agent"} •{" "}
              {selectedAgent.primaryModel.name}
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="flex items-end gap-3">
          <div className="flex-1 relative">
            <textarea
              ...
              rows={1}
              className={cn(
                "w-full px-4 py-3 rounded-xl border border-[--color-border]",
                "bg-[--color-background] resize-none",
