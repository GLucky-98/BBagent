...
export function TimerPanel({ agentId }: TimerPanelProps) {
  ...
  return (
    <div className="border-t border-(--color-border) bg-(--color-background)">
          ...
          <tbody>
            {timers.map((timer) => (
              editingName === timer.name ? (
                <tr key={timer.name} className="border-b border-(--color-border)/50 bg-(--color-secondary)/30">
                ...
                <tr key={timer.name} className="border-b border-(--color-border)/50 hover:bg-(--color-secondary)/30 transition-colors">
                  ...
                  <td className="px-3 py-2">
                    <span className={cn(
                      ...
                      <span className={cn(
                        ...
                        timer.running ? "bg-green-500" : timer.enabled ? "bg-yellow-500" : "bg-gray-400"
                      )} />
            ...
            {isAdding && (
              <tr className="border-b border-(--color-border)/50 bg-(--color-primary)/5">
                <td className="px-3 py-1.5">
                  <div>
                    <input
                      value={addRow.name}
      ...
      <div className="flex items-center justify-end px-3 py-2 border-t border-(--color-border)/50">
        <button
